...
async fn main() -> Result<(), Error> {
    ...
    let init_method_name: &str = "init_concordium_staking"; // Example
    ...
    use concordium_staking::MyInputType; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("concordium_staking.receive".to_string()),
