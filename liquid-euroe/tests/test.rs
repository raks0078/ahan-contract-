...
const PUBLIC_KEY: [u8; 32] = [
    120, 154, 141, 6, 248, 239, 77, 224, 80, 62, 139, 136, 211, 204, 105, 208, 26, 11, 2, 208, 195, 253,
    29, 192, 126, 199, 208, 39, 69, 4, 246, 32,
];

const SIGNATURE_UPDATE_OPERATOR: SignatureEd25519 = SignatureEd25519([
    199, 250, 51, 48, 15, 210, 20, 180, 70, 191, 98, 217, 109, 67, 115, 94, 195, 81, 16, 157, 59, 26,
    36, 147, 91, 196, 254, 133, 149, 27, 148, 124, 130, 206, 68, 195, 139, 189, 244, 43, 253, 12,
    58, 17, 102, 63, 203, 35, 159, 54, 94, 59, 12, 193, 48, 78, 144, 112, 245, 149, 12, 181, 74, 10,
]);
...
fn test_view_circulating_supply() {
    ...
    let invoke = chain
        .contract_invoke(ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            ...
            receive_name: OwnedReceiveName::new_unchecked(
                "euroe_stablecoin.viewSupply".to_string()
            ),
    ...
    let rv: ViewCirculatingSupply = invoke
        .parse_return_value()
        .expect("ViewCirculatingSupply return value");
    ...
    chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount: Amount::zero(),
                receive_name: OwnedReceiveName::new_unchecked(
                    "euroe_stablecoin.setPaused".to_string()
                ),
                address: contract_address,
...
fn test_block_on_mint() {
    ...
    let update = chain
        .contract_update(
            SIGNER,
            RANDOM_BLOCKLIST_ACCOUNT,
            RANDOM_BLOCKLIST_ADDRESS,
            Energy::from(10000),
            UpdateContractPayload {
                amount: Amount::zero(),
                receive_name: OwnedReceiveName::new_unchecked("euroe_stablecoin.mint".to_string()),
...
fn test_account_transfer() {
    ...
    let transfer_params = TransferParams::from(
        vec![concordium_cis2::Transfer {
            from: ALICE_ADDR,
    ...
    let update = chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount: Amount::zero(),
                receive_name: OwnedReceiveName::new_unchecked(
                    "euroe_stablecoin.transfer".to_string()
                ),
                address: contract_address,
                message: OwnedParameter::from_serial(&transfer_params).expect("Transfer params"),
            }
...
fn test_add_operator() {
    ...
    let update = chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount: Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked(
                "euroe_stablecoin.updateOperator".to_string()
            ),
            address: contract_address,
    ...
    let invoke = chain
        .contract_invoke(ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount: Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked(
                "euroe_stablecoin.operatorOf".to_string()
            ),
            address: contract_address,
...
fn test_contract_token_metadata() {
    ...
    let update = chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount: Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked(
                "euroe_stablecoin.tokenMetadata".to_string()
            ),
            address: contract_address,
    ...
    let rv: TokenMetadataQueryResponse = update
        .parse_return_value()
...
fn test_pause_functionality() {
    ...
    // Check that the correct error is returned.
    let mint_rv: ContractError = mint_update
        .parse_return_value()
    ...
    // Check that the correct error is returned.
    let burn_rv: ContractError = burn_update
        .parse_return_value()
        .expect("ContractError return value");
    ...
    // Check that the correct error is returned.
    let transfer_rv: ContractError = transfer_update
        .parse_return_value()
        .expect("ContractError return value");
    ...
    // Check that the correct error is returned.
    let operator_rv: ContractError = operator_update
        .parse_return_value()
        .expect("ContractError return value");
...
fn test_remove_roles() {
    ...
    chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount: Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked(
                "euroe_stablecoin.removeRole".to_string()
            ),
            address: contract_address,
...
fn test_blocklist_functionality() {
    ...
    // Check that the correct error is returned.
    let mint_rv: ContractError = update_mint
        .parse_return_value()
        .expect("ContractError return value");
    ...
    // Check that the correct error is returned.
    let burn_rv: ContractError = update_burn
        .parse_return_value()
        .expect("ContractError return value");
    ...
    // Check that the correct error is returned.
    let transfer_rv: ContractError = tranfer_update
        .parse_return_value()
        .expect("ContractError return value");
...
fn test_blocklist_functionality_with_wrong_role() {
    ...
    // Check that the correct error is returned.
    let transfer_rv: ContractError = update
        .parse_return_value()
        .expect("ContractError return value");
    ...
    chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount: Amount::zero(),
                receive_name: OwnedReceiveName::new_unchecked(
                    "euroe_stablecoin.unblock".to_string()
                ),
                address: contract_address,
...
fn test_inside_signature_permit_update_operator() {
    ...
    let invoke = chain
        .contract_invoke(BOB, BOB_ADDR, Energy::from(10000), UpdateContractPayload {
            ...
            address: contract_address,
            receive_name: OwnedReceiveName::new_unchecked(
                "euroe_stablecoin.viewMessageHash".to_string()
            ),
            message: OwnedParameter::from_serial(&permit_update_operator_param).expect(
                "Should be a valid inut parameter"
            ),
        })
        .expect("Should be able to query viewMessageHash");

    let message_hash: HashSha2256 = from_bytes(&invoke.return_value).expect(
    ...
    let update = chain
        .contract_update(
            ...
            UpdateContractPayload {
                ...
                address: contract_address,
                receive_name: OwnedReceiveName::new_unchecked(
                    "euroe_stablecoin.permit".to_string()
                ),
                message: OwnedParameter::from_serial(&permit_update_operator_param).expect(
                    "Should be a valid inut parameter"
                ),
...
fn test_inside_signature_permit_transfer() {
    ...
    let invoke = chain
        .contract_invoke(BOB, BOB_ADDR, Energy::from(10000), UpdateContractPayload {
            ...
            message: OwnedParameter::from_serial(&permit_transfer_param).expect(
                "Should be a valid inut parameter"
            ),
        })
        .expect("Should be able to query viewMessageHash");
...
fn get_balances(
    ...
    let rv: ContractBalanceOfQueryResponse = invoke
        .parse_return_value()
        .expect("BalanceOf return value");
    rv
}
...
fn initialize_contract_with_alice_tokens_for_permit(
    ...
    let (mut chain, contract_address, keypairs) =
        initialize_chain_and_contract_for_permit(generate_keys);
